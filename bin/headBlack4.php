...
<head>
	...
	');
	if(!$mobile)
	{		echo('<link rel="stylesheet" type="text/css" href="/common/masterBlack.css" />');
	} else {
...
<table width="100%">
  <tr>
    ...
    <td td align="center"><img src="/common/lowellroboticslogo.png" style="height:180px;" alt="Lowell Robotics" /></td>
	<td td align="center" valign="middle" width="200" bgcolor="White"><a href="http://www.usfirst.org/" target="_blank"><img src="/common/FIRST.png" style="width:165px;height:170px;" alt="FIRST Logo"/></a></td>
  </tr>
</table>
